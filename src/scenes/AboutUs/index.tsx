...
const AboutUs = ({setSelectedPage}: Props) => {
  return (
    <div id='aboutus' className='mx-auto md:w-5/6 md:h-5/6 px-5 md:px-0 md:py-20'>
        
        <h3 className="text-4xl text-center font-bold my-8">About Us</h3>
        <div className="relative">
            <Spinner></Spinner>
            <div className="bg-white py-10 xl:py-16 xl:[100px] 2xl:px-[200px] px-5">
                <div className="absolute xl:right-32 lg:right-14 lg:top-[460px] xl:top-1/4 md:block hidden md:top-[360px] md:right-7">
                    <img className="md:w-[120px] xl:w-3/4" src={down} alt="" />
                </div>
                <div className="absolute lg:left-14 lg:top-[500px] xl:left-32 xl:top-1/4 md:block hidden md:top-[400px] md:left-4">
                    <img className="md:w-[170px] xl:w-full" src={up} alt="" />
                </div>
                <div className="flex flex-col md:flex-row items-center md:items-end gap-10 py-6 md:py-16">
                    <div className="flex-1">
                        <img src={img2} alt="" />
                    </div>
                    <div className="flex-1">
                        <div className="border-r border-b border-[#772EFA] pr-4 pb-4 md:pb-6">
                            <h3></h3>
                            <h3 className='text-2xl md:text-4xl font-bold pb-4 md:pb-7 leading-tight'>Explore Our <span className='bg-gradient-to-r from-[#772EFA] to-[#4B6FFF] text-transparent bg-clip-text'>Dynamic</span><br /> E-Commerce Platform</h3>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-end gap-10 py-6 md:py-16">
                    <div className="flex-1">
                        <div className="border-l border-b border-[#772EFA] pr-4 pb-4 pl-4 md:pl-6 md:pb-6">
                            <h3></h3>
                            <h3 className='text-2xl md:text-4xl font-bold pb-4 md:pb-7 leading-tight'>Discover Our <span className='bg-gradient-to-r from-[#772EFA] to-[#4B6FFF] text-transparent bg-clip-text'>Library</span><br />Management Project</h3>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-end gap-10 py-6 md:py-16">
                    ...
                    <div className="flex-1">
                        <div className="border-r border-b border-[#772EFA] pr-4 pb-4 md:pr-6 md:pb-6">
                            <h3></h3>
                            <h3 className='text-2xl md:text-4xl font-bold pb-4 md:pb-7 leading-tight'><span className='bg-gradient-to-r from-[#772EFA] to-[#4B6FFF] text-transparent bg-clip-text'>Dive Deep</span> Into Detailed<br />Product Delights!</h3>
